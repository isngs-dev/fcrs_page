...
const SERIES = [
  { key: "booked" as const, label: "booked", color: "#191a17" },
  { key: "completed" as const, label: "completed", color: "#e4f222" },
  { key: "noShow" as const, label: "no-show", color: "#70716a" },
  { key: "cancelled" as const, label: "cancelled", color: "#c2452d" },
];
...
export function BookingsBars({ data }: { data: BookingsReport }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-3 text-[11px] text-[#96978e]">
        {SERIES.map((s) => (
